				...
				cValue.ForEach(func(ck, cv gjson.Result) bool {
					...
					if ccValue := cv.Get("children"); ccValue.Exists() {
						...
						ccValue.ForEach(func(cck, ccv gjson.Result) bool {
							ccItem := NetworkAccessConditionChildrenChildrenChildren{}
...
func (data *NetworkAccessCondition) updateFromBody(ctx context.Context, res gjson.Result) {
...
func (data *NetworkAccessCondition) isNull(ctx context.Context, res gjson.Result) bool {
	if !data.Name.IsNull() {
		return false
	}
	if !data.Description.IsNull() {
