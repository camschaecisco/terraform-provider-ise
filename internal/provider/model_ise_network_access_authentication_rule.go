...
type NetworkAccessAuthenticationRuleChildrenChildren struct {
	...
	DictionaryValue types.String                                              `tfsdk:"dictionary_value"`
	Operator        types.String                                              `tfsdk:"operator"`
	Children        []NetworkAccessAuthenticationRuleChildrenChildrenChildren `tfsdk:"children"`
}

type NetworkAccessAuthenticationRuleChildrenChildrenChildren struct {
	ConditionType   types.String                                                      `tfsdk:"condition_type"`
	Id              types.String                                                      `tfsdk:"id"`
	IsNegate        types.Bool                                                        `tfsdk:"is_negate"`
	AttributeName   types.String                                                      `tfsdk:"attribute_name"`
	...
	DictionaryValue types.String                                                      `tfsdk:"dictionary_value"`
	Operator        types.String                                                      `tfsdk:"operator"`
	Children        []NetworkAccessAuthenticationRuleChildrenChildrenChildrenChildren `tfsdk:"children"`
}

type NetworkAccessAuthenticationRuleChildrenChildrenChildrenChildren struct {
	ConditionType   types.String                                                              `tfsdk:"condition_type"`
	Id              types.String                                                              `tfsdk:"id"`
	IsNegate        types.Bool                                                                `tfsdk:"is_negate"`
	AttributeName   types.String                                                              `tfsdk:"attribute_name"`
	...
	DictionaryValue types.String                                                              `tfsdk:"dictionary_value"`
	Operator        types.String                                                              `tfsdk:"operator"`
	Children        []NetworkAccessAuthenticationRuleChildrenChildrenChildrenChildrenChildren `tfsdk:"children"`
}

type NetworkAccessAuthenticationRuleChildrenChildrenChildrenChildrenChildren struct {
	ConditionType   types.String                                                                      `tfsdk:"condition_type"`
	Id              types.String                                                                      `tfsdk:"id"`
	IsNegate        types.Bool                                                                        `tfsdk:"is_negate"`
	AttributeName   types.String                                                                      `tfsdk:"attribute_name"`
	...
	DictionaryValue types.String                                                                      `tfsdk:"dictionary_value"`
	Operator        types.String                                                                      `tfsdk:"operator"`
	Children        []NetworkAccessAuthenticationRuleChildrenChildrenChildrenChildrenChildrenChildren `tfsdk:"children"`
}

type NetworkAccessAuthenticationRuleChildrenChildrenChildrenChildrenChildrenChildren struct {
	ConditionType   types.String `tfsdk:"condition_type"`
	Id              types.String `tfsdk:"id"`
	IsNegate        types.Bool   `tfsdk:"is_negate"`
	AttributeName   types.String `tfsdk:"attribute_name"`
...
func (data *NetworkAccessAuthenticationRule) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get("response.rule.condition.children"); value.Exists() {
		data.Children = make([]NetworkAccessAuthenticationRuleChildren, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			...
			if cValue := v.Get("children"); cValue.Exists() {
				item.Children = make([]NetworkAccessAuthenticationRuleChildrenChildren, 0)
				cValue.ForEach(func(ck, cv gjson.Result) bool {
					cItem := NetworkAccessAuthenticationRuleChildrenChildren{}
					...
					if ccValue := cv.Get("children"); ccValue.Exists() {
						cItem.Children = make([]NetworkAccessAuthenticationRuleChildrenChildrenChildren, 0)
						ccValue.ForEach(func(cck, ccv gjson.Result) bool {
							ccItem := NetworkAccessAuthenticationRuleChildrenChildrenChildren{}
	...
	if value := res.Get("response.identitySourceName"); value.Exists() && value.Type != gjson.Null {
		data.IdentitySourceName = types.StringValue(value.String())
	} else {
		data.IdentitySourceName = types.StringNull()
	}
	if value := res.Get("response.ifAuthFail"); value.Exists() && value.Type != gjson.Null {
		data.IfAuthFail = types.StringValue(value.String())
	} else {
		data.IfAuthFail = types.StringNull()
	}
	if value := res.Get("response.ifProcessFail"); value.Exists() && value.Type != gjson.Null {
		data.IfProcessFail = types.StringValue(value.String())
	} else {
		data.IfProcessFail = types.StringNull()
	}
	if value := res.Get("response.ifUserNotFound"); value.Exists() && value.Type != gjson.Null {
