...
func (data *DeviceAdminAuthenticationRule) fromBody(ctx context.Context, res gjson.Result) {
	...
	if value := res.Get("response.rule.condition.children"); value.Exists() {
		data.Children = make([]DeviceAdminAuthenticationRuleChildren, 0)
		value.ForEach(func(k, v gjson.Result) bool {
			item := DeviceAdminAuthenticationRuleChildren{}
			...
			if cValue := v.Get("children"); cValue.Exists() {
				item.Children = make([]DeviceAdminAuthenticationRuleChildrenChildren, 0)
				cValue.ForEach(func(ck, cv gjson.Result) bool {
					...
					if ccValue := cv.Get("children"); ccValue.Exists() {
						...
						ccValue.ForEach(func(cck, ccv gjson.Result) bool {
							ccItem := DeviceAdminAuthenticationRuleChildrenChildrenChildren{}
...
func (data *DeviceAdminAuthenticationRule) updateFromBody(ctx context.Context, res gjson.Result) {
